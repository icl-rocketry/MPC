...
# Which variables do I need? Whoch variables need constraining?
...
x1 = plotter(dispx[:], ylabel = "X-Disp", linewidth = 2)
x2 = plotter(dispy[:], ylabel = "Y-Disp", linewidth = 2)
x3 = plotter(dispz[:], ylabel = "Z-Disp", linewidth = 2)
v1 = plotter(velx[:], ylabel = "X-Velocity", linewidth = 2)
v2 = plotter(vely[:], ylabel = "Y-Velocity", linewidth = 2)
v3 = plotter(velz[:], ylabel = "Z-Velocity", linewidth = 2)
a1 = plotter(accx[:], ylabel = "X-Acceleration", linewidth = 2)
a2 = plotter(accy[:], ylabel = "Y`-Acceleration", linewidth = 2)
a3 = plotter(accz[:], ylabel = "Z-Acceleration", linewidth = 2)
t1 = plotter(thrustx[:], ylabel = "X-Thrust", linewidth = 2)
t2 = plotter(thrusty[:], ylabel = "Y-Thrust", linewidth = 2)
t3 = plotter(thrustz[:], ylabel = "Z-Thrust", linewidth = 2)
Plots.plot(x1, x2, x3, 
        v1, v2, v3, 
        a1, a2, a3,
        t1, t2, t3,
